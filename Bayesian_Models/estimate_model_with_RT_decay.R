...
sr_1k1v_with_RT_decay_stanfile <- "/Users/dddd1007/project2git/cognitive_control_model/Bayesian_Models/bayesian_learner_sr_1k1v_estimate_RT_by_trial_add_decay.stan"

sr_1k1v_with_RT_decay_learner <- cmdstan_model(sr_1k1v_with_RT_decay_stanfile)

output_dir <- "/Users/dddd1007/project2git/cognitive_control_model/data/output/bayesian_learner_samplers/estimate_with_RT_decay/"
...
# for (i in sub_num_list) {
    ...
    fit1 <- sr_1k1v_with_RT_decay_learner$sample(
        data = data_list,
        chains = 4,
        parallel_chains = 4,
        refresh = 100,
