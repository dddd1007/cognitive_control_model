...
for s, subject in enumerate(subjects):
    ...
    for m, model_type in enumerate(models):
        ...
        for fit_with_error in range(0, 2):
            for fit_with_logRT in range(0, 1):
                ...
                bestModel.save_data()
# # group results
RLCCmodel.group_parameter_results(subjects, models, '', '_single_alpha')
#RLCCmodel.group_parameter_results(subjects, models, 'logRT_', '_SR')
RLCCmodel.group_parameter_results(subjects, models, 'with_error_', '_single_alpha')
