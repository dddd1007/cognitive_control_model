...
sr_estimate_RT_as_obj_func_decay_stanfile <- "/Users/dddd1007/project2git/cognitive_control_model/Bayesian_Models/bayesian_learner_sr_estimate_RT_as_obj_func_decay.stan"

sr_estimate_RT_as_obj_func_decay_learner <- cmdstan_model(sr_estimate_RT_as_obj_func_decay_stanfile)

output_dir <- "/Users/dddd1007/project2git/cognitive_control_model/data/output/bayesian_learner_samplers/SR_RT_as_obj_func_decay_logRT/"
...
for (i in sub_num_list) {
    ...
    fit <- sr_estimate_RT_as_obj_func_decay_learner$sample(
        data = data_list,
        chains = 4,
        parallel_chains = 4,
        refresh = 100,
