...
function model_evaluation(env, realsub, number_iterations)
    ...
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_1a,
                                number_iterations=number_iterations))
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_1a1d,
                                number_iterations=number_iterations * 10))
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_1a1d1e,
                                number_iterations=number_iterations * 30))
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_1a1d1CCC,
                                number_iterations=number_iterations * 50))
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_1a1d1e1CCC,
                                number_iterations=number_iterations * 100))

    println("+++ " * subname * " 2a model +++")

    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_2a,
                                number_iterations=number_iterations))
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_2a1d,
                                number_iterations=number_iterations * 10))
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_2a1d1e,
                                number_iterations=number_iterations * 30))
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_2a1d1CCC,
                                number_iterations=number_iterations * 50))
    push!(eval_result,
          fit_and_evaluate_base(env, realsub; model_type=:_2a1d1e1CCC,
                                number_iterations=number_iterations * 100))
...
Threads.@threads for sub_num in 1:36
    ...
    println("========= Begin Sub " * repr(sub_num) * " ==========")    eval_results[each_subinfo.sub_tag[1]] = model_evaluation(each_env, each_subinfo, 10000)
end
