...
imgpath = "../data/output/RLModels/img_rl_model_hyperopt/" 
csvpath = "../data/output/RLModels/"
...
for sub_num in 1:36
    ...
    optim_param, eval_result, verbose_table = hyperopt_rllearn_withCCC(each_env, each_subinfo, 1000000)
