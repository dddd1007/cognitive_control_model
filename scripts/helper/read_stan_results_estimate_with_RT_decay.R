...
stan_verbose_loc <- "/Users/dddd1007/project2git/cognitive_control_model/data/output/bayesian_learner_samplers/estimate_with_RT_decay"
...
for (sub_num in unique(sub_data$Subject_num)) {
    ...
    result <- data.frame(
        ...
        alpha = alpha, beta = beta, sigma = sigma, decay_rate = decay_rate
    )
