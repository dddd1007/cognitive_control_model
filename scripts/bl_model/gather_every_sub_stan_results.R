library(tidyverse)
data_loc <- "/Users/dddd1007/project2git/cognitive_control_model/data/output/bayesian_learner_samplers/1k1v_neg_v/extracted_data/"
...
write.csv(all_data_result, paste0(data_loc, "all_data_gathered.csv"))
