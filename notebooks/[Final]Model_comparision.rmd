...
for (i in seq_len(length(subject_list))) {
    ...
    rl_sr_decay_data <- select(tmp_data, RT, rl_sr_decay,
...
for (i in seq_len(length(subject_list))) {
    tmp_data <- dummy_columns(filter(bl_rl_data_miniblock,
                              ...
                              "mini_block") %>%
                select(-mini_block)
    tmp_data$bl_ab <- range01(tmp_data$bl_ab)
    tmp_data$bl_sr <- range01(tmp_data$bl_sr)
    tmp_data$rl_ab <- range01(tmp_data$rl_ab)
    tmp_data$rl_sr <- range01(tmp_data$rl_sr)
    tmp_data$rl_sr_decay <- range01(tmp_data$rl_sr_decay)
...
rl_ab_result_corr <- vector(mode = "numeric", 
                           length = length(subject_list))
rl_sr_result_corr <- vector(mode = "numeric", 
                           length = length(subject_list))
rl_sr_decay_result_corr <- vector(mode = "numeric", 
                           length = length(subject_list))
bl_ab_result_corr <- vector(mode = "numeric", 
                           length = length(subject_list))
bl_sr_result_corr <- vector(mode = "numeric", 
                           length = length(subject_list))
...
for (i in seq_len(length(subject_list))) {
    ...
    bl_ab_result_corr[i] <- cor(tmp_data$RT, tmp_data$bl_ab)
    bl_sr_result_corr[i] <- cor(tmp_data$RT, tmp_data$bl_sr)
    rl_ab_result_corr[i] <- cor(tmp_data$RT, tmp_data$rl_ab)
    rl_sr_result_corr[i] <- cor(tmp_data$RT, tmp_data$rl_sr)
    rl_sr_decay_result_corr[i] <- cor(tmp_data$RT, tmp_data$rl_sr_decay)
}

corr_result <- data.frame(bl_ab = bl_ab_result_corr,
                          bl_sr = bl_sr_result_corr,
                          rl_ab = rl_ab_result_corr,
                          rl_sr = rl_sr_result_corr,
                          rl_sr_decay = rl_sr_decay_result_corr)
```